...
class TestBaseParser(TestCase):
    def test_entity_valid_id_parser(self):
        ...
        self.assertTrue(parser.is_valid_entity_id("Q2147483647"))
        self.assertFalse(parser.is_valid_entity_id("Q1234345523535534545455342545"))
        self.assertFalse(parser.is_valid_entity_id("Q2147483648"))
        self.assertFalse(parser.is_valid_entity_id("Q0"))
        self.assertTrue(parser.is_valid_entity_id("M1"))
        self.assertTrue(parser.is_valid_entity_id("M1234"))
        self.assertTrue(parser.is_valid_entity_id("M2147483647"))
        self.assertFalse(parser.is_valid_entity_id("M1234345523535534545455342545"))
        self.assertFalse(parser.is_valid_entity_id("M2147483648"))
        self.assertFalse(parser.is_valid_entity_id("M0"))
        ...
        self.assertTrue(parser.is_valid_entity_id("P2147483647"))
        self.assertFalse(parser.is_valid_entity_id("P1234345523535534545455342545"))
        self.assertFalse(parser.is_valid_entity_id("P2147483648"))
        self.assertFalse(parser.is_valid_entity_id("P0"))
        self.assertFalse(parser.is_valid_entity_id("1"))
        ...
        self.assertTrue(parser.is_valid_entity_id("L2147483647"))
        self.assertFalse(parser.is_valid_entity_id("L1234345523535534545455342545"))
        self.assertFalse(parser.is_valid_entity_id("L2147483648"))
        self.assertFalse(parser.is_valid_entity_id("L0"))
        self.assertFalse(parser.is_valid_entity_id("1"))
        self.assertFalse(parser.is_valid_entity_id("12P1234"))
    ...
    def test_item_valid_id_parser(self):
        ...
        self.assertTrue(parser.is_valid_item_id("Q2147483647"))
        self.assertFalse(parser.is_valid_item_id("Q1234345523535534545455342545"))
        self.assertFalse(parser.is_valid_item_id("Q2147483648"))
        self.assertFalse(parser.is_valid_item_id("Q0"))
        self.assertTrue(parser.is_valid_item_id("M1"))
        self.assertTrue(parser.is_valid_item_id("M1234"))
        self.assertTrue(parser.is_valid_item_id("M2147483647"))
        self.assertFalse(parser.is_valid_item_id("M1234345523535534545455342545"))
        self.assertFalse(parser.is_valid_item_id("M2147483648"))
        self.assertFalse(parser.is_valid_item_id("M0"))
    ...
    def test_property_valid_id_parser(self):
        ...
        self.assertTrue(parser.is_valid_property_id("P2147483647"))
        self.assertFalse(parser.is_valid_property_id("P1234345523535534545455342545"))
        self.assertFalse(parser.is_valid_property_id("P2147483648"))
        self.assertFalse(parser.is_valid_property_id("P0"))
    ...
    def test_source_valid_id_parser(self):
        ...
        self.assertTrue(parser.is_valid_source_id("S2147483647"))
        self.assertFalse(parser.is_valid_source_id("S1234345523535534545455342545"))
        self.assertFalse(parser.is_valid_source_id("S2147483648"))
        self.assertFalse(parser.is_valid_source_id("S0"))
    ...
    def test_lexeme_valid_id_parser(self):
        ...
        self.assertTrue(parser.is_valid_lexeme_id("L2147483647"))
        self.assertFalse(parser.is_valid_lexeme_id("L1234345523535534545455342545"))
        self.assertFalse(parser.is_valid_lexeme_id("L2147483648"))
        self.assertFalse(parser.is_valid_lexeme_id("L0"))
